...
namespace SoftKitty.WSFL
{
    public class Localization : MonoBehaviour
    {
        ...
        static Dictionary<string, int> LocalizationIndex = new Dictionary<string, int>();
        #endregion
        ...
        public static string[] ReadLocalizationFiles(string _absulutePath)
        {
        ...
        public static string GetString(string _text,int _forceLanguage=-1)
        {
            ...
            {
                return LocalizationDic[GetKey(_text)][_forceLanguage == -1 ? SelectedLanguage :
                _forceLanguage].Replace("<br>", "\n");
            }
            ...
            else
            {
                ...
                {
                    UncatchedStringList.Add(_text.Replace("\r", "<br>").Replace("\n", "<br>"));
                }
#endif
            }
