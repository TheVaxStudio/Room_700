    ...
    public class VhsFx : ScriptableRendererFeature
    {
        ...
        public class PassExecution : ScriptableRenderPass
        {
...
#if UNITY_RENDER_GRAPH
            VolFx.InitApiRg _initApiRg;
            
            VolFx.CallApiRg _callApiRg;
#endif
            VolFx.InitApiLeg _initApiLeg;

            VolFx.CallApiLeg _callApiLeg;
            
            ProfilingSampler _profiler;
            ...
            ref RenderingData renderingData)
            {
                ...
                var invVp = (renderingData.cameraData.GetProjectionMatrix() * 
