...
namespace VolFx
{
    public static class Utils
    {
        ...
        public static Matrix4x4 s_IndentityInvert = new Matrix4x4(new Vector4(1, 0, 0, 0),
        ...
        private static void _initFullScreenMeshes()
        {
            ...
            if (s_FullscreenQuad == null)
            {
                ...
                s_FullscreenQuad.SetIndices(new[]
                { 
                    0, 1, 2, 2, 1, 3 
                },
            ...
            if (s_FullscreenTriangle == null)
            {
                ...
                s_FullscreenTriangle.vertices = _verts(0.0f);

                s_FullscreenTriangle.uv = _texCoords();
                
                s_FullscreenTriangle.triangles = new int[3]
                { 
                    0, 1, 2 
                };
        ...
        public static void Blit(CommandBuffer cmd, RTHandle source,
        RTHandle destination, Material material, int pass = 0, bool invert = false)
        {
            cmd.SetGlobalTexture(s_MainTexId, source);
            
            cmd.SetRenderTarget(destination, 0);
            
            cmd.DrawMesh(FullscreenMesh, invert ? s_IndentityInvert : Matrix4x4.identity,
            material, 0, pass);
        }
        ...
        public static TKey MaxOrDefault<TSource, TKey>(this IEnumerable<TSource> source,
        Func<TSource, TKey> selector, TSource noOptionsValue = default)
        {
        ...
        public static TSource MaxOrDefault<TSource, TKey>(this IEnumerable<TSource> source,
        Func<TSource, TKey> selector, IComparer<TKey> comparer, TSource fallback = default)
        {
